...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GETPACKAGERESPONSE']._serialized_end=131
  _globals['_SILO']._serialized_start=133
  _globals['_SILO']._serialized_end=206
